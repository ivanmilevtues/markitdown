---
component_id: 3.3
component_name: PDF & Fixed-Layout Processor
---

# PDF & Fixed-Layout Processor

## Component Description

A specialized parser for PDF files that reconstructs logical document flow from coordinate-based text fragments. It includes sophisticated logic for merging partial lines, identifying form fields, and reconstructing tables from raw word positions.
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_pdf_converter.py (lines 120-395)
```
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_pdf_converter.py (lines 14-57)
```
