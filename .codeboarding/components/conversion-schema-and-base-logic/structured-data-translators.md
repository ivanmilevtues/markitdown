---
component_id: 2.3
component_name: Structured Data Translators
---

# Structured Data Translators

## Component Description

Handles non-HTML structured formats that require specific parsing logic to maintain hierarchical relationships, such as Jupyter Notebooks or YAML.

---

## Key References:

### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_ipynb_converter.py (lines 15-96)
```
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_yaml_converter.py (lines 10-38)
```
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_yaml_converter.py (lines 41-52)
```
