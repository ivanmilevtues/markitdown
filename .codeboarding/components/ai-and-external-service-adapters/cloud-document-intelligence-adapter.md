---
component_id: 5.1
component_name: Cloud Document Intelligence Adapter
---

# Cloud Document Intelligence Adapter

## Component Description

Interfaces with Azure AI Document Intelligence to process complex PDFs and images. It handles the full lifecycle of remote document analysis, including uploading streams, polling for completion, and mapping the service's JSON layout response to semantic Markdown.
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_doc_intel_converter.py (lines 237-254)
```
    def convert(
        self,
        file_stream: BinaryIO,
