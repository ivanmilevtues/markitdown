---
component_id: 4
component_name: Specialized Extraction Utilities
---

# Specialized Extraction Utilities

## Component Description

Provides low-level logic for handling non-trivial elements like math formulas and PDF table reconstruction.
