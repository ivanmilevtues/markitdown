---
component_id: 3.4
component_name: Cloud-Native Intelligence Adapter
---

# Cloud-Native Intelligence Adapter

## Component Description

Provides a high-fidelity alternative to local parsing by offloading document analysis to Azure AI Document Intelligence. This is used for complex layouts where local heuristic-based parsing may fall short.
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_doc_intel_converter.py (lines 28-29)
```
