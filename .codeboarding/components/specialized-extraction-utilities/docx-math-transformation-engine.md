---
component_id: 4.1
component_name: Docx Math Transformation Engine
---

# Docx Math Transformation Engine

## Component Description

Orchestrates the identification and conversion of Office Math Markup Language (OMML) within Word documents. It scans the document XML structure, isolates mathematical blocks, and delegates the translation to a recursive visitor-based LaTeX engine.

---

## Key References:

### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converter_utils/docx/pre_process.py (lines 118-156)
```
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converter_utils/docx/math/omml.py (lines 170-400)
```
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converter_utils/docx/math/omml.py (lines 75-124)
```
