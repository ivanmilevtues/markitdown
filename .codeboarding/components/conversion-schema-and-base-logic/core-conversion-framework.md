---
component_id: 2.1
component_name: Core Conversion Framework
---
...
Defines the fundamental abstract base classes and data models that enforce consistency across the entire library, acting as the contract layer for all specific converters.
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_plain_text_converter.py (lines 33-71)
```
