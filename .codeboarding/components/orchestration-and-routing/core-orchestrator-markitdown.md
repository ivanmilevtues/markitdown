---
component_id: 1.1
component_name: Core Orchestrator (MarkItDown)
---

# Core Orchestrator (MarkItDown)

## Component Description

The central hub that manages the conversion lifecycle. It maintains a registry of converters, performs input normalization (handling streams and charsets), and implements the routing logic to dispatch tasks to the appropriate converter based on file extension or MIME type.
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/_markitdown.py (lines 252-300)
```
    def convert(
        self,
        source: Union[str, requests.Response, Path, BinaryIO],
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/_markitdown.py (lines 641-671)
```
    def register_converter(
        self,
        converter: DocumentConverter,
