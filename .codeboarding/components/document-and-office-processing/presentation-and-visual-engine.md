---
component_id: 3.2
component_name: Presentation & Visual Engine
---

# Presentation & Visual Engine

## Component Description

Manages the hierarchical extraction of content from PowerPoint presentations. It performs spatial analysis of shapes, slides, and notes, and integrates with LLM services to generate descriptive captions for embedded images and charts.
...
### /Users/imilev/StartUp/demo/test/markitdown/packages/markitdown/src/markitdown/converters/_llm_caption.py (lines 7-50)
```
def llm_caption(
